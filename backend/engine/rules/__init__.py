from .arms import BicepCurlRule, WristCurlRule, HammerCurlRule
...
EXERCISE_RULES = {
    ...
    "Bicycle Crunches": CrunchRule,
    "Plank": PlankRule,
    "Side Plank": PlankRule,
    "Dead Bug": PlankRule,
    "Ab Wheel Rollout": PlankRule,
    "Plank Jacks": BurpeeRule,
    ...
    # Cardio
    "Jumping Jacks": CardioRule,
    "High Knees": CardioRule,
    "Butt Kicks": CardioRule,
    "Running in Place": CardioRule,
    "Squat Jumps": CardioRule,
    "Skater Jumps": CardioRule,
    "Jump Lunges": CardioRule,
}
